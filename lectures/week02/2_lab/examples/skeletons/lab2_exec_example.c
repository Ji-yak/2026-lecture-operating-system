...
static void demo_execl(void)
{
    ...
    /* TODO: Call execl() to run /bin/echo with arguments "echo", "Hello", "from", "execl!"
     *       Remember: the argument list must end with (char *)NULL
     */
}
...
static void demo_execlp(void)
{
    ...
    /* TODO: Call execlp() to run "ls" with arguments "ls", "-l", "-h", "/tmp"
     *       Remember: execlp searches PATH, so no full path needed
     */
}
...
static void demo_execv(void)
{
    ...
    /* TODO: Create a char *args[] array with {"echo", "Hello", "from", "execv!", NULL}
     *       Then call execv("/bin/echo", args)
     */
}
...
static void demo_execvp(void)
{
    ...
    /* TODO: Create a char *args[] array with {"echo", "execvp works!", NULL}
     *       Then call execvp("echo", args)
     */
}
...
static void demo_pattern(void)
{
    ...
    /* TODO: Call execlp() to run the "date" command
     *       Hint: execlp("date", "date", (char *)NULL)
     */
}
...
static void demo_exec_fail(void)
{
    ...
    /* TODO: Call execlp() with a nonexistent program name like "this_program_does_not_exist"
     *       After the call (which will fail), call perror("exec failed (expected error)")
     *       and exit(127)
     */
}
